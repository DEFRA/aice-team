...
Read the full AICE GitHub Actions style guide at `resources/github-actions.md` (relative to this plugin's root) before writing or reviewing any workflow files.
